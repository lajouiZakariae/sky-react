...
export default function DarkSideDashboard({ children }: PropsWithChildren) {
    ...
    return (
        <div>
            ...
            <div className="hidden border-r border-gray-200 md:flex md:w-64 md:flex-col md:fixed md:inset-y-0">
